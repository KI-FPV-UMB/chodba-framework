...
#        self.top.overrideredirect(True)
        ...
        l_title = tkinter.Label(f_title, text=title, font=('times', 30), bg=bgcol, justify=tkinter.LEFT)
        ...
        l_text = tkinter.Label(f_text, text=text, font=('Aerial', 17), bg=bgcol, justify=tkinter.LEFT)
